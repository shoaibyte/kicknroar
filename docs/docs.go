...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.LoginRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_response.AuthResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_response.ErrorResponse"
                        }
                    },
                    "401": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.RefreshRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.SignupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/matches": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by status (open, full, cancelled, completed)",
                        "name": "status",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.CreateMatchRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/matches/{id}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Match update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.UpdateMatchRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/matches/{id}/participants": {
            "get": {
                "security": [
                    {
                        "Bearer": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_response.UserResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.UpdateUserRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.CreateVenueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/venues/nearby": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by field type (futsal, football, astro)",
                        "name": "field_type",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/kicknroar_internal_dto_request.UpdateVenueRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "kicknroar_internal_dto_request.CreateMatchRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Casual futsal match for intermediate players"
                },
                "duration_hours": {
                    "type": "number",
                    "maximum": 4,
        ...
        "kicknroar_internal_dto_request.CreateVenueRequest": {
            ...
            "properties": {
                "address": {
                    "type": "string",
                    "example": "Road 27, Dhanmondi, Dhaka"
                },
                "capacity": {
                    "type": "integer",
                    "minimum": 1,
                ...
                "name": {
                    ...
                    "maxLength": 100,
                    "minLength": 2,
                    "example": "Dhanmondi Futsal Arena"
                },
                "operating_hours": {
                    "type": "object",
                    "additionalProperties": true
        ...
        "kicknroar_internal_dto_request.LoginRequest": {
        ...
        "kicknroar_internal_dto_request.RefreshRequest": {
        ...
        "kicknroar_internal_dto_request.SignupRequest": {
        ...
        "kicknroar_internal_dto_request.UpdateMatchRequest": {
            ...
            "properties": {
                ...
                "description": {
                    "type": "string",
                    "example": "Updated match description"
                },
                "duration_hours": {
                    "type": "number",
                    "maximum": 4,
                ...
                "rules_notes": {
                    "type": "string",
                    "example": "Updated rules and notes"
                },
                "skill_level_required": {
                    "type": "string",
                    "enum": [
                ...
                "title": {
                    ...
                    "maxLength": 100,
                    "minLength": 3,
                    "example": "Weekend Futsal Match - Updated"
                },
                "visibility": {
                    "type": "string",
                    "enum": [
        ...
        "kicknroar_internal_dto_request.UpdateUserRequest": {
        ...
        "kicknroar_internal_dto_request.UpdateVenueRequest": {
            "description": "Venue update request - all fields are optional",
            "type": "object",
            "properties": {
                "address": {
                    "type": "string",
                    "example": "Road 27, Dhanmondi, Dhaka - Updated"
                },
                "capacity": {
                    "type": "integer",
                    "minimum": 1,
                ...
                "name": {
                    ...
                    "maxLength": 100,
                    "minLength": 2,
                    "example": "Dhanmondi Futsal Arena - Updated"
                },
                "operating_hours": {
                    "type": "object",
                    "additionalProperties": true
        ...
        "kicknroar_internal_dto_response.AuthResponse": {
        ...
        "kicknroar_internal_dto_response.ErrorDetail": {
        ...
        "kicknroar_internal_dto_response.ErrorResponse": {
            "description": "Standard error response format",
            "type": "object",
            "properties": {
                "error": {
                    "$ref": "#/definitions/kicknroar_internal_dto_response.ErrorDetail"
                }
            }
        },
        "kicknroar_internal_dto_response.UserResponse": {
            "description": "User profile information",
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string",
                    "example": "2024-11-25T19:00:00Z"
                },
                "email": {
                    "type": "string",
                    "example": "john.doe@example.com"
