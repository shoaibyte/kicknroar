...
type MatchQuery struct {
	...
	withParticipants  *MatchParticipantQuery
...
func (_q *MatchQuery) QueryCreator() *UserQuery {
...
func (_q *MatchQuery) QueryVenue() *VenueQuery {
...
func (_q *MatchQuery) QueryParticipants() *MatchParticipantQuery {
...
func (_q *MatchQuery) QueryNotifications() *NotificationQuery {
...
func (_q *MatchQuery) WithCreator(opts ...func(*UserQuery)) *MatchQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *MatchQuery) WithVenue(opts ...func(*VenueQuery)) *MatchQuery {
	query := (&VenueClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MatchQuery) WithParticipants(opts ...func(*MatchParticipantQuery)) *MatchQuery {
	query := (&MatchParticipantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MatchQuery) WithNotifications(opts ...func(*NotificationQuery)) *MatchQuery {
	query := (&NotificationClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *MatchQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Match, error) {
	...
	if query := _q.withCreator; query != nil {
		if err := _q.loadCreator(ctx, query, nodes, nil,
			func(n *Match, e *User) { n.Edges.Creator = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVenue; query != nil {
		if err := _q.loadVenue(ctx, query, nodes, nil,
			func(n *Match, e *Venue) { n.Edges.Venue = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParticipants; query != nil {
		if err := _q.loadParticipants(ctx, query, nodes,
			func(n *Match) { n.Edges.Participants = []*MatchParticipant{} },
			func(n *Match, e *MatchParticipant) { n.Edges.Participants = append(n.Edges.Participants, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withNotifications; query != nil {
		if err := _q.loadNotifications(ctx, query, nodes,
			func(n *Match) { n.Edges.Notifications = []*Notification{} },
			func(n *Match, e *Notification) { n.Edges.Notifications = append(n.Edges.Notifications, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MatchQuery) loadCreator(ctx context.Context, query *UserQuery, nodes []*Match, init func(*Match), assign func(*Match, *User)) error {
...
func (_q *MatchQuery) loadVenue(ctx context.Context, query *VenueQuery, nodes []*Match, init func(*Match), assign func(*Match, *Venue)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Match)
	for i := range nodes {
		fk := nodes[i].VenueID
...
func (_q *MatchQuery) loadParticipants(ctx context.Context, query *MatchParticipantQuery, nodes []*Match, init func(*Match), assign func(*Match, *MatchParticipant)) error {
	...
	query.Where(predicate.MatchParticipant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(match.ParticipantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.match_participants
		if fk == nil {
			return fmt.Errorf(`foreign-key "match_participants" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "match_participants" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *MatchQuery) loadNotifications(ctx context.Context, query *NotificationQuery, nodes []*Match, init func(*Match), assign func(*Match, *Notification)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Match)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Notification(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(match.NotificationsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.match_notifications
		if fk == nil {
			return fmt.Errorf(`foreign-key "match_notifications" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "match_notifications" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *MatchQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withCreator != nil {
			_spec.Node.AddColumnOnce(match.FieldCreatorID)
		}
		if _q.withVenue != nil {
			_spec.Node.AddColumnOnce(match.FieldVenueID)
		}
	}
