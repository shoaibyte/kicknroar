...
type UserQuery struct {
	...
	withStats          *UserStatsQuery
	withCreatedMatches *MatchQuery
	withParticipations *MatchParticipantQuery
	withNotifications  *NotificationQuery
	withOwnedVenues    *VenueQuery
...
func (_q *UserQuery) QueryStats() *UserStatsQuery {
...
// QueryCreatedMatches chains the current query on the "created_matches" edge.
func (_q *UserQuery) QueryCreatedMatches() *MatchQuery {
...
func (_q *UserQuery) QueryParticipations() *MatchParticipantQuery {
	query := (&MatchParticipantClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
// QueryOwnedVenues chains the current query on the "owned_venues" edge.
func (_q *UserQuery) QueryOwnedVenues() *VenueQuery {
	query := (&VenueClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (_q *UserQuery) WithStats(opts ...func(*UserStatsQuery)) *UserQuery {
	query := (&UserStatsClient{config: _q.config}).Query()
...
// WithCreatedMatches tells the query-builder to eager-load the nodes that are connected to
// the "created_matches" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithCreatedMatches(opts ...func(*MatchQuery)) *UserQuery {
	query := (&MatchClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withCreatedMatches = query
	return _q
}
...
func (_q *UserQuery) WithParticipations(opts ...func(*MatchParticipantQuery)) *UserQuery {
	query := (&MatchParticipantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
// WithOwnedVenues tells the query-builder to eager-load the nodes that are connected to
// the "owned_venues" edge. The optional arguments are used to configure the query builder of the edge.
func (_q *UserQuery) WithOwnedVenues(opts ...func(*VenueQuery)) *UserQuery {
	query := (&VenueClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	_q.withOwnedVenues = query
	return _q
}
...
func (_q *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := _q.withStats; query != nil {
		if err := _q.loadStats(ctx, query, nodes, nil,
			func(n *User, e *UserStats) { n.Edges.Stats = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withCreatedMatches; query != nil {
		if err := _q.loadCreatedMatches(ctx, query, nodes,
			func(n *User) { n.Edges.CreatedMatches = []*Match{} },
			func(n *User, e *Match) { n.Edges.CreatedMatches = append(n.Edges.CreatedMatches, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withParticipations; query != nil {
		if err := _q.loadParticipations(ctx, query, nodes,
			func(n *User) { n.Edges.Participations = []*MatchParticipant{} },
			func(n *User, e *MatchParticipant) { n.Edges.Participations = append(n.Edges.Participations, e) }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withOwnedVenues; query != nil {
		if err := _q.loadOwnedVenues(ctx, query, nodes,
			func(n *User) { n.Edges.OwnedVenues = []*Venue{} },
			func(n *User, e *Venue) { n.Edges.OwnedVenues = append(n.Edges.OwnedVenues, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *UserQuery) loadStats(ctx context.Context, query *UserStatsQuery, nodes []*User, init func(*User), assign func(*User, *UserStats)) error {
...
func (_q *UserQuery) loadCreatedMatches(ctx context.Context, query *MatchQuery, nodes []*User, init func(*User), assign func(*User, *Match)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.Match(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.CreatedMatchesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_created_matches
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_created_matches" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_created_matches" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (_q *UserQuery) loadParticipations(ctx context.Context, query *MatchParticipantQuery, nodes []*User, init func(*User), assign func(*User, *MatchParticipant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.MatchParticipant(func(s *sql.Selector) {
	...
	for _, n := range neighbors {
		fk := n.user_participations
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_participations" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_participations" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (_q *UserQuery) loadOwnedVenues(ctx context.Context, query *VenueQuery, nodes []*User, init func(*User), assign func(*User, *Venue)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*User)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.withFKs = true
	query.Where(predicate.Venue(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(user.OwnedVenuesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.user_owned_venues
		if fk == nil {
			return fmt.Errorf(`foreign-key "user_owned_venues" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "user_owned_venues" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
